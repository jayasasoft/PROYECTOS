...
class cuserlevels_edit extends cuserlevels {
	...
	function ValidateForm() {
		...
		if (in_array("userlevelpermissions", $DetailTblVar) && $GLOBALS["userlevelpermissions"]->DetailEdit) {
			if (!isset($GLOBALS["userlevelpermissions_grid"])) $GLOBALS["userlevelpermissions_grid"] = new cuserlevelpermissions_grid(); // get detail page object
			$GLOBALS["userlevelpermissions_grid"]->ValidateGridForm();
		}
		...
		if ($rs->EOF) {
			...
			if ($bUpdateRow) {
				...
				if ($EditRow) {
					if (in_array("userlevelpermissions", $DetailTblVar) && $GLOBALS["userlevelpermissions"]->DetailEdit) {
						if (!isset($GLOBALS["userlevelpermissions_grid"])) $GLOBALS["userlevelpermissions_grid"] = new cuserlevelpermissions_grid(); // Get detail page object
						$EditRow = $GLOBALS["userlevelpermissions_grid"]->GridUpdate();
					}
				}
	...
	function SetUpDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("userlevelpermissions", $DetailTblVar)) {
				...
				if ($GLOBALS["userlevelpermissions_grid"]->DetailEdit) {
					$GLOBALS["userlevelpermissions_grid"]->CurrentMode = "edit";
					$GLOBALS["userlevelpermissions_grid"]->CurrentAction = "gridedit";
...
<?php
	if (in_array("userlevelpermissions", explode(",", $userlevels->getCurrentDetailTable())) && $userlevelpermissions->DetailEdit) {
?>
